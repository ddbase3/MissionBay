...
class AiAssistantNode extends AbstractAgentNode {
	...
	public function execute(array $inputs, array $resources, IAgentContext $context): array {
		...
		while ($loopGuard++ < $maxLoops) {
			if ($logger) $logger->log($scope, "Loop iteration $loopGuard, sending messages (" . count($messages) . " total)");
			...
			if ($logger) $logger->log($scope, "Final response received, breaking loop.");
			break;
		}
