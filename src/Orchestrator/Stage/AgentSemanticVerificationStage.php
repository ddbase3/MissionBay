...
/**
 * AgentSemanticVerificationStage
 *
...
final class AgentSemanticVerificationStage implements IAgentStage {
	...
	public function getDescription(): string {
		return 'Validates a terminal tool-phase decision once, using the accumulated normalized observations, before final response generation.';
	}
