 ...
 */
final class AgentResultVerificationStage implements IAgentStage {

	public const VERIFIER = 'structural-tool-result-contract';

	public function __construct(
		private readonly string $id = 'result-verification',
		private readonly string $stageName = 'result-verification'
	) {}

	public static function getName(): string {
		return 'agentresultverificationstage';
	}
	...
	public function getDescription(): string {
		return 'Verifies tool-result identity, status, error contracts, uniqueness, and action correlation before observations are committed.';
	}
