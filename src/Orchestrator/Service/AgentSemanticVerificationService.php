		...
		return [
			[
				...
				'content' => implode("\n", [
					...
					'When authoritative observations materially contradict each other on a fact needed for the answer, do not mark that fact verified until the contradiction is resolved or explicitly bounded. Recommend continue when an eligible tool can reasonably resolve it.',
					'A failed tool result is evidence about that attempted call, not evidence that the requested capability is globally unavailable. If the error identifies invalid arguments, unsupported syntax, schema, field, or operation usage and an eligible tool can support a corrected attempt or discovery step, recommend continue rather than accepting the failed attempt as final.',
